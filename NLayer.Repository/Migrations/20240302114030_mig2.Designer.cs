            ...
            modelBuilder.Entity("NLayer.Core.Entity.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 2, 0, 0, 0, 0, DateTimeKind.Local));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 3, 2, 14, 40, 30, 775, DateTimeKind.Local).AddTicks(6720),
                            Name = "Pilot Kalem",
                            Price = 120m,
                            Stock = 100
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2024, 3, 2, 14, 40, 30, 775, DateTimeKind.Local).AddTicks(6726),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2024, 3, 2, 14, 40, 30, 775, DateTimeKind.Local).AddTicks(6727),
